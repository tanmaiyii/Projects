...
public class TwitterSportsMapper extends Mapper<Object, Text, Text, IntWritable> {
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		// here we match the two tables in the joins
		  ...
		  // the value of the hashtable (sport)-fields[7] is set as the key for the mapper

			sport.set(athlete.get(athleteName));
